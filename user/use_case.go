...
//цель здесь - автоматически генерировать имитированную версию интерфейса UserUseCase, эта имитация помещается в каталог ../mocks с названием файла mockUserUsecase.go
